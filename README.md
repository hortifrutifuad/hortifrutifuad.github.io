...
- **Custo de Servidor:** R$ 0,00.
- **Design:** "Boutique Clean" focado no frescor dos produtos.
- **Diferencial Logístico:** O site não atua como e-commerce fechado, evitando estornos. Atua como um gerador de leads altamente qualificados para o WhatsApp.

### 2. Funil de Vendas Automatizado (n8n + Evolution API) *[Fase 2]*
- Triagem automática do cliente via robô.
- Cálculo de frete dinâmico via distância.
